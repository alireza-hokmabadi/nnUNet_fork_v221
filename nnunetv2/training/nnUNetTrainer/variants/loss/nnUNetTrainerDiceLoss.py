...
class nnUNetTrainerFlexibleLoss_ep100_strongSampling(nnUNetTrainerFlexibleLoss):
    class_weights = None
    weight_ce = 1.0
    weight_dice = 1.0
    num_epochs = 100
...
#%% Specific loss versions ----------------------------------------------------
class nnUNetTrainerFlexibleLoss_ep250_ce07_dice03(nnUNetTrainerFlexibleLoss):
    class_weights = None
    weight_ce = 0.7
    weight_dice = 0.3
    num_epochs = 250
...
class nnUNetTrainerFlexibleLoss_ep250_ce03_dice07(nnUNetTrainerFlexibleLoss):
    class_weights = None
    weight_ce = 0.3
    weight_dice = 0.7
    num_epochs = 250
...
class nnUNetTrainerFlexibleLoss_ep250_ce07_dice03__class_weights_strongSampling(nnUNetTrainerFlexibleLoss):
    class_weights = [.1, 2, 3, 1, 6]  # {'Background': 0, 'LV_Epi': 1, 'LV_Pap1': 2, 'LV_Endo': 3, 'LV_Pap2': 4}
    weight_ce = 0.7
    weight_dice = 0.3
    num_epochs = 250
