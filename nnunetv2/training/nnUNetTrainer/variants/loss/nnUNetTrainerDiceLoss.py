...
class nnUNetTrainerFlexibleLoss_100ep(nnUNetTrainerFlexibleLoss):
    class_weights = None
    weight_ce = 1.0
    weight_dice = 1.0
    num_epochs = 100
...
class nnUNetTrainerFlexibleLoss_250ep(nnUNetTrainerFlexibleLoss):
    class_weights = None
    weight_ce = 1.0
    weight_dice = 1.0
    num_epochs = 250
...
class nnUNetTrainerFlexibleLoss_500ep(nnUNetTrainerFlexibleLoss):
    class_weights = None
    weight_ce = 1.0
    weight_dice = 1.0
    num_epochs = 500
...
class nnUNetTrainerFlexibleLoss_250ep_ce2(nnUNetTrainerFlexibleLoss):
    class_weights = None
    weight_ce = 2.0
    weight_dice = 1.0
    num_epochs = 250
